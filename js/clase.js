...
btnAgregar.addEventListener("click", function(){
    if(todosPro.llamadoProductos().length<20){
        ...
        let productoNuevo = new Producto(nom, cod, cant, cost);
...
btnListar.addEventListener("click", function(){
    ...
    proTotales.forEach(function(pro){
        ...
        "</li><li>Cantidad: "+ pro.cant +"</li><li>Costo: "+ pro.cost +"</li><li>Valor mercancia: "+ pro.valorM +"</li></ul>";
    });
});
...
btnBuscar.addEventListener("click", function(){ 
    ...
    if(proEncontrado){
        ...
        "</li><li>Cantidad: "+ proEncontrado.cant +"</li><li>Costo: "+ proEncontrado.cost +"</li><li>Valor mercancia: "+ proEncontrado.valorM +"</li></ul>";
    }
    else{
        alert("Codigo no encontrado");
    }
